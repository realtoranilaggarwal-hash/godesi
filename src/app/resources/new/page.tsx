    ...
    <div className="mx-auto max-w-2xl space-y-5">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-600">
          ...
          pages you pick. You pay per 1,000 views and the link retires automatically once
      ...
      <Card>
        <form action={startLinkCheckoutAction} className="space-y-4">
          <Field label="Link title" hint="What visitors will read, e.g. “Cheap flights to India”">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <Field label="Show on category" hint="Leave blank to show across the site">
              <select
                name="categorySlug"
            ...
            <Field label="Link type">
              <select name="kind" defaultValue="SPONSORED" className={inputClass}>
                <option value="SPONSORED">Sponsored</option>
                <option value="AFFILIATE">Affiliate</option>
              </select>
            </Field>
            <Field label="Views pack">
              <select name="impressions" defaultValue={RESOURCE_PACKS[0]} className={inputClass}>
          ...
          <p className="text-xs text-slate-500">
            Links are reviewed before they appear. Adult, misleading or malware links are
            rejected and refunded. Every paid link is labelled sponsored or affiliate.
          </p>
        </form>
      </Card>
    </div>
