...
export default async function AdminPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <AdminTabs
        tabs={[
          { id: "listings", label: "Listings", count: pending },
          { id: "events", label: "Events" },
          { id: "banners", label: "Banners" },
          {
            id: "ads-awaiting-approval",
            label: "Ad orders",
            count: pendingAds.length,
          },
          { id: "upi", label: "UPI payments", count: pendingUpi.length },
          { id: "users-and-subscriptions", label: "Members" },
          { id: "discount-coupons", label: "Coupons" },
          { id: "news", label: "News" },
          ...
          { id: "auto-share", label: "Auto-share" },
          {
            id: "connect",
            label: "Connect",
            count: pendingMeetups.length,
          },
          { id: "business-claims", label: "Claims", count: claims.length },
          {
            id: "places-of-worship-awaiting-review",
            label: "Temples",
            count: pendingWorship.length,
          },
          { id: "resources", label: "Resources" },
          {
            id: "reward-point-values",
            label: "Rewards",
            count: openRedemptions.length,
          },
          { id: "team-access", label: "Team" },
        ]}
      />
      ...
      <Card id="journalists">
        ...
        <p className="mb-3 text-sm text-slate-500">
          Confirm a reporter&rsquo;s mobile number (message the number on WhatsApp)
          and any ID you have sighted. A press card only issues once the member
          reaches Editor level with these ticked.
        </p>
        {journalists.length ? (
          <div className="overflow-x-auto">
            <table className="w-full min-w-[720px] text-sm">
