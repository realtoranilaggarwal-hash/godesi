...
Send me the course list with timings and fees and one photo of the classroom or your logo, and I will set it up today: [CATEGORY LINK]`,
  ...
  },
  {
    ...
    whyUs: [
      ...
      "The paid part is plain: the Elite interview with a 30–60 second video is a one-time $500 for a year, and while the launch offer runs $250 holds the profile for five years, a professionally produced three-minute film is $500, and placement boosts are $100, $250 or $500 to sit higher in their section. Nothing else is charged.",
    ...
    steps: [
      ...
      },
      {
        ...
        detail:
          "Once the profile is theirs, offer the interview and video. The price is $500 for a year, but the launch offer holds the profile for five years for $250 — lead with that. It is optional; the profile stays either way. Never suggest a claim depends on paying.",
      },
      {
...
If you would like it told properly, we also do an Elite interview: a short conversation by phone, WhatsApp, Zoom or Facebook Live, published on your profile with a 30–60 second video. That is a one-time $500 for a year, and while our launch offer runs $250 holds your profile for five years. A professionally produced three-minute film from your own photos and footage is $500.
