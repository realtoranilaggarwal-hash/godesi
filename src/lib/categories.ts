...
export const CATEGORY_TREE: CategorySeed[] = [
  ...
  },
  {
    ...
    icon: "🏢",
    color: "orange",
    blurb: "Buy, sell, rent — agents, builders and PG accommodation",
    children: [
      "Property Dealers",
      "Flats for Sale",
      "Flats for Rent",
  ...
  },
  {
    ...
    icon: "💐",
    color: "rose",
    blurb: "Planners, photographers, decorators, DJs and venues",
    children: [
      "Wedding Planners",
      "Photographers",
      "Videographers",
  ...
  },
  {
    ...
    icon: "🧑‍💻",
    color: "teal",
    blurb: "Openings, part-time work, drivers, maids and consultants",
    children: [
      "Full Time Jobs",
      "Part Time Jobs",
      "Work From Home",
