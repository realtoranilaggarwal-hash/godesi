...
const WEDDING_SETS: Record<string, SpecialtySet> = {
  ...
  Photographers: weddingSet({
    title: "Select the photography you do",
    hint: "Pick every shoot and deliverable you offer.",
    options: [
  ...
  "DJ & Sound": weddingSet({
    ...
    hint: "Pick every set and rig you bring.",
    options: [
      "Wedding DJ",
      "Sangeet DJ",
      "Reception DJ",
      "Bollywood sets",
      "Punjabi & bhangra sets",
      "Tamil / Telugu sets",
      "Garba & dandiya sets",
      "Hip-hop & top 40 sets",
      "Live mixing with dhol",
      "MC / anchoring",
      "Sound system rental",
      "Microphones & speeches setup",
      "Uplighting & dance floor lights",
      "LED walls & screens",
      "Laser & effect lighting",
      "Fog & cold sparklers",
      "Karaoke setup",
      "Baraat portable sound",
      "Outdoor / poolside setup",
