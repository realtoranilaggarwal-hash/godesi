...
export const ADMIN_SECTIONS: AdminSection[] = [
  ...
  { href: "/admin/temples", label: "Temples", icon: "🛕", need: "worship" },
  {
  ...
  { href: "/admin/website", label: "Websites", icon: "🌐", need: "staff" },
  ...
  { href: "/admin/media", label: "Media team", icon: "🎙️", need: "staff" },
  {
